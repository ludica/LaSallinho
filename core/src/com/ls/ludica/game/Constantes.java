...
public class Constantes {
	...
	public static final int ALTURA_MAPA_EM_BLOCO = 25;    // altura do mapa (em quantidade de blocos) - FASE DEMONSTRACAO
	...
	// Fase Demonstracao
	public static final int X_INICIAL = BLOCO * 1; // posicao X inicial do La Sassinho
	public static final int Y_INICIAL = BLOCO * 18; // posicao Y inicial do La Sallinho
	...
	public static final float MAXJUMP = BLOCO * 3.2f;
